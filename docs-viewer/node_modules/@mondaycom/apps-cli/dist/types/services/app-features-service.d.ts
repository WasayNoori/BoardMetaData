import { z } from 'zod';
import { appFeatureSchema, createAppFeatureReleaseSchema, listAppFeaturesSchema } from '../../services/schemas/app-features-schemas.js';
...
export declare enum BUILD_TYPES {
    CUSTOM_URL = "custom_url",
    MONDAY_CODE = "monday_code"
}
export declare enum AppFeatureType {
